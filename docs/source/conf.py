# -*- coding: utf-8 -*-
#
# trivial-imap documentation build configuration file, created by
...
htmlhelp_basename = 'trivial-imapdoc'
...
latex_documents = [
  ('index', 'trivial-imap.tex', u'trivial-imap Documentation',
...
man_pages = [
    ('index', 'trivial-imap', u'trivial-imap Documentation',
...
texinfo_documents = [
  ('index', 'trivial-imap', u'trivial-imap Documentation',
   u'Alexander Artemenko', 'trivial-imap', 'Easy to use IMAP client library, which solves common use cases.',
   'Miscellaneous'),
]
